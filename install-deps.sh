...
sudo pacman -S zsh zsh-completions zsh-syntax-highlightinglightdm lightdm-slick-greeter i3 alacritty dmenu rofi polybar xdg-user-dirs xss-lock polkit-gnome gnome-keyring feh mplayer picom firefox thunar gparted cutefish-calculator baobab gimp pavucontrol blueman lxappearance qt5ct gdb neofetch btop tldr tree unzip unrar wget flameshot gpick dunst ttf-dejavu ttf-droid noto-fonts noto-fonts-emoji ttf-font-awesome gvfs ntfs-3g
