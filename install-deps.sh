...
sudo pacman -S zsh zsh-completions zsh-autosuggestions zsh-syntax-highlighting lightdm-slick-greeter i3 alacritty dmenu rofi polybar xdg-user-dirs xss-lock polkit-gnome gnome-keyring redshift feh mplayer picom firefox thunar tumbler gparted cutefish-calculator baobab gimp blueman lxappearance qt5ct gdb neofetch btop tldr tree unzip unrar wget flameshot gpick dunst ttf-dejavu ttf-droid noto-fonts noto-fonts-emoji ttf-font-awesome gvfs gvfs-mtp usbutils ntfs-3g pavucontrol
